...
if (appsBtn) appsBtn.addEventListener('click', ()=> openModal('appsModal'));

const appsNavLink = document.getElementById('appsNavLink');
if (appsNavLink) {
  appsNavLink.addEventListener('click', (e)=>{
    e.preventDefault();
    openModal('appsModal');
  });
}
...
if (signupBtnMain) signupBtnMain.addEventListener('click', ()=>{ window.location.href = 'auth.html'; });
